# human.py
# Go outside and touch some Python
import os
import random
...
class Human:
	...
	def __init__(self, name: str, age: int, knowledge: int):
		...
		# "Check knowledge and see if " + self.name + " is actually smart"
	...
	def info(self):
		print(f"Hello! My name is {self.name}. I am {str(self.age)} years old.")
		# f"Check knowledge and see if {self.name} is actually smart" # No, samr, you're doing it wrong, that's not how comments work
		if self.knowledge > 50:
			print("I am smart.")
		elif self.knowledge <= 50 and self.knowledge > 20:
			print("I'm alright in terms of knowledge.")
